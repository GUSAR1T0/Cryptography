...
public class FilesReaderTest {
    ...
    public void testReadFilesForEncryption() throws Exception {
        ...
        Assert.assertTrue("src\\test\\resources\\encrypt".equals(properties.get(0).getDirectory()));
        ...
        Assert.assertTrue("src\\test\\resources\\encrypt".equals(properties.get(1).getDirectory()));
    ...
    public void testReadFilesForDecryption() throws Exception {
        ...
        Assert.assertTrue(properties.size() == 2);
        Assert.assertTrue("file".equals(properties.get(0).getFilename()));
        Assert.assertTrue("src\\test\\resources\\decrypt".equals(properties.get(0).getDirectory()));
        ...
        Assert.assertTrue("12345678".equals(properties.get(0).getKey()));
        Assert.assertTrue("file2".equals(properties.get(1).getFilename()));
        Assert.assertTrue("src\\test\\resources\\decrypt".equals(properties.get(1).getDirectory()));
    ...
    public void testReadFilesForAllCipher() throws Exception {
        ...
        Assert.assertTrue("src\\test\\resources\\encrypt".equals(properties.get(2).getDirectory()));
        ...
        Assert.assertTrue("src\\test\\resources\\encrypt".equals(properties.get(3).getDirectory()));
